...
<head>
    ...
    <script type="text/javascript">
        ...
        setInterval(function (){
            var selectValue = $("#txtzg18110902_lx18110900001_Value").val();
            if(selectValue=="公告"){
                $("#txtzg18110902_zdr1811090001_Title").css('display','none');
                $("#txtzg18110902_zdr1811090001").css('display','none');
            }else if(selectValue=="通知"){
                $("#txtzg18110902_zdr1811090001_Title").css('display','block');
                $("#txtzg18110902_zdr1811090001").css('display','block');
            }
        },500)
        <%--jsEnd--%>
    </script>
                            ...
                            <div class="layui-row">
                                <div class="layui-col-xs12 layui-col-sm12 layui-col-md12 layui-form-item">
                                    <c:if test="${starnode=='true'}">
                                        <div style="width: 100px; height: 30px;float: right;text-align: center;" class="layui-nav-item layui-hide-xs"><a class="layui-btn layui-btn-xs layui-btn-normal" href="javascript:void(0);" onclick="openflowsub('lct','${wkflwId}','${starnode}')">查看流程</a></div>
                            ...
                            <div class="layui-row">
                                <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
                                    <form class="layui-form layui-form-pane" id="${formid}" action="/flowpage/flowaddsave/${formid}.do" method='POST'>
                                                ...
                                                <div class='layui-row'>
                                                    <div class='layui-col-xs12'>
                                                        <div class="layui-input-block">
                                                            <a class='layui-btn' herf='javascript:void(0)' onclick="flowformsave(this,'${formid}')">保存</a>
                                                            <a class='layui-btn layui-btn-primary' herf='javascript:void(0)' onclick="flowformreset(this,'${formid}')">重置</a>
                                                            <a class='layui-btn layui-btn-primary' herf='javascript:void(0)' onclick="flowformcancel(this,'${formid}','${wkflwId}')">取消</a>
                                                                <%--modiaBegin--%>
                                                                <%--modiaEnd--%>
                                                        </div>
                                                    </div>
                                        ...
                                        <input type='hidden' id='workOrderNO' name='workOrderNO' autocomplete='off' value='${workOrderNO}' class='layui-input'>
                            ...
                            <div class="layui-col-xs12 layui-col-sm12 layui-col-md12">
                                <form class="layui-form" id="${formid}_info" action="/task/flowtask.do" method='POST'>
                                    ...
                                    <div class='layui-row'>
                                        <div class='layui-col-xs12'>
                                            <div class="layui-input-block">
                                                <a class='layui-btn' herf='javascript:void(0)' onclick="flowformsend(this,'${formid}')">发送</a>
                                                <a class='layui-btn layui-btn-primary' herf='javascript:void(0)' onclick="flowformmodi(this,'${formid}')">修改</a>
                                                <a class='layui-btn layui-btn-primary' herf='javascript:void(0)' onclick="flowformcancel(this,'${formid}','${wkflwId}')">取消</a>
                                                    <%--aBegin--%>
                                                    <%--aEnd--%>
                                            </div>
