...
<c:if test="${type=='1'}">
    ...
    <div id="opiondiv" style="width:794px;height: 1090px">
        ...
        <div style="width:1000px;height: 55%">
            <table style="width: 100%;height: 100px">
                <tr>
                    <td style="width: 100%;font-size:30px;height:80px" align='center' valign='middle' colspan="3">
                        河北省产品质量监督检验研究院业务车辆派车单
                    </td>
                </tr>
                <tr>
            ...
            <table border="1" cellspacing="0" style="width: 100%;height: 450px;font-size:15px;">
                <tr style="height: 50px">
                    ...
                    <td style="width: 15%; text-align: center">车辆归属/用车类型</td>
                    <td style="width: 18%; text-align: center">
                        <c:if test="${data.get(2).size()>0 && data.get(2) != null}">
                            ${data.get(2).get(0).get("clgs191115001")}/${data.get(0).get(0).get("yclx191118001")}
                        </c:if>
                    </td>
                </tr>
                <tr style="height: 50px">
                ...
                <tr style="height: 50px">
                    ...
                    <td style="width: 27%;text-align: center" colspan="2">
                        <c:if test="${data.get(3).size()>0 && data.get(3) != null}">
                            起：${fn:substring(data.get(3).get(0).get("kssj191115003"), 0, 16)}
                        </c:if>
                        <br/>
                        <c:if test="${data.get(3).size()>0 && data.get(3) != null}">
                            止：${fn:substring(data.get(3).get(0).get("jssj191115003"), 0, 16)}
                        </c:if>
                    </td>
        ...
        <div style="width:1000px;height: 55%;margin-top:150px">
            <table style="width: 100%;height: 100px">
                <tr>
                    <td style="width: 100%;font-size:30px;height:80px" align='center' valign='middle' colspan="3">
                        河北省产品质量监督检验研究院业务车辆派车单
...
<c:if test="${type=='3'}">
    ...
    <div id="opiondiv" style="width:794px;height: 1000px;">
        <c:forEach items="${datali}" var="data" varStatus="status">
            <div style="width:1000px;height: 545px;padding-top: 50px;">
                <table style="width: 100%;height: 95px;">
                    <tr>
                        <td style="width: 100%;font-size:30px;height:75px" align='center' valign='middle' colspan="3">
                            河北省产品质量监督检验研究院业务车辆派车单
                        </td>
                    </tr>
                    <tr>
                ...
                <table border="1" cellspacing="0" style="width: 100%;height: 450px;font-size:15px;">
                    <tr style="height: 50px">
                        ...
                        <td style="width: 15%; text-align: center">车辆归属/车辆类型</td>
                        <td style="width: 18%; text-align: center">
                            <c:if test="${data.get(2).size()>0 && data.get(2) != null}">
                                ${data.get(2).get(0).get("clgs191115001")}/${data.get(0).get(0).get("yclx191118001")}
                            </c:if>
                    ...
                    <tr style="height: 50px">
                        <td style="width: 27%;text-align: center" colspan="2">
                            <div style="font-size: 18px;text-align: left">管理员审批:</div>
                            <div style="text-align: center;font-size: 13px">
                                <c:if test="${data.get(4).size()>0 && data.get(4) != null}">
                                    ${data.get(4).get(0).get("spyj191115004")}
                                    ${data.get(4).get(0).get("recordName")}
            ...
            <div style="width:1000px;height: 545px;padding-top: 95px;padding-bottom: 180px">
                <table style="width: 100%;height: 95px;">
                    <tr>
                        <td style="width: 100%;font-size:30px;height:75px" align='center' valign='middle' colspan="3">
                            河北省产品质量监督检验研究院业务车辆派车单
