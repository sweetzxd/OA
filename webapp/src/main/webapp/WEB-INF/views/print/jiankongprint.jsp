...
<script type="text/javascript">
    ...
    function exportwordseal() {
        $("#sealdiv").wordExport('省质检研究院调取监控视频审批单')
    }
...
<table style="width: 756px;height: 100px">
    <tr>
        <td style="width: 756px;font-size:30px;height:100px" align='center' valign='middle' colspan="4">省质检研究院调取监控视频审批单
        </td>
    </tr>
</table>
<table border="1" cellspacing="0" style="width: 794px;height: 1090px">
    ...
    <tr style="height: 50px;">
        <td style="width: 100px;text-align: center">调取视频监控原因</td>
