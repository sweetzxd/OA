...
<div>
    ...
    <label style="text-align: left">合计金额：${hjjine}</label>
    <label style="text-align: left">部门耗材管理员：&nbsp&nbsp&nbsp&nbsp</label>
    <label style="text-align: left">部门主任：${depthead}</label>
</div>
<script>
