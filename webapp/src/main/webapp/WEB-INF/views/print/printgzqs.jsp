...
<div id="opiondiv" style="width: 756px;height: 1086px;">
    <table style="width: 756px;height: 1px">
        <tr>
            <td style="width: 756px;" align='center' valign='middle' colspan="4">
                    <div style="font-size:25px;padding: 10px;">河北省质检研究院征求意见单</div>
    ...
    <table border="1" cellspacing="0" style="width: 756px;height: 886px">
        ...
        <tr style="height:70px">
            ...
            <td style="width: 656px;text-align: center" colspan="4">
        ...
        <tr style="height:70px">
            ...
            <td style="width: 656px;text-align: center" colspan="4">
                <c:if test="${data.get('liudebin')==''}">
                    <label>${data.get('liudebin').get("msg")}</label>
                    <label>${data.get('liudebin').get("name")}</label>
                    <label>${data.get('liudebin').get("date")}</label>
                </c:if>
            </td>
        </tr>
        <tr style="height:70px">
        ...
        <tr style="height:70px">
            ...
            <td style="width: 656px;text-align: center" colspan="4">
                <c:if test="${data.get('hanzhennian')==''}">
                    <label>${data.get('hanzhennian').get("msg")}</label>
                    <label>${data.get('hanzhennian').get("name")}</label>
                    <label>${data.get('hanzhennian').get("date")}</label>
                </c:if>
            </td>
        </tr>
        <tr style="height:70px">
        ...
        <tr style="height:70px">
            ...
            <td style="width: 656px;text-align: center" colspan="4">
                <c:if test="${data.get('lvxiaofei')==''}">
                    <label>${data.get('lvxiaofei').get("msg")}</label>
                    <label>${data.get('lvxiaofei').get("name")}</label>
                    <label>${data.get('lvxiaofei').get("date")}</label>
                </c:if>
            </td>
        </tr>
        <tr style="height:70px">
            ...
            <td style="width: 656px;text-align: center" colspan="4">
                <c:if test="${data.get('malianbing')==''}">
                    <label>${data.get('malianbing').get("msg")}</label>
                    <label>${data.get('malianbing').get("name")}</label>
                    <label>${data.get('malianbing').get("date")}</label>
                </c:if>
            </td>
        </tr>
        <tr style="height:70px">
