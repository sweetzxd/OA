...
<table style="width: 756px;height: 90px;padding-top: 35px">
    <tr>
        <td style="width: 756px;font-size:30px;height:90px" align='center' valign='middle' colspan="4">现金借款延期归还申请单
        </td>
    </tr>
</table>
...
<table border="1" cellspacing="0" style="width: 756px;height: 450px; overflow-y:scroll">
    <tr>
        ...
        <td style="text-align: center">￥${data.get(11).get("jkje200522001")}</td>
        <td style="text-align: center" width="20%">原借款日期</td>
      ...
      <tr>
        ...
        <td width="20%" style="text-align: center">用途</td>
        <td style="text-align: center">${data.get(11).get("yt20052200002")}</td>
    </tr>
    <tr>
        <td style="text-align: center" width="20%">延期还款日期</td>
        ...
        <td style="text-align: center">${data.get(11).get("yqghl20052202")}</td>
    </tr>
