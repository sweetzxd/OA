...
<script type="text/javascript">
    ...
    function exportwordseal() {
        $("#sealdiv").wordExport('河北省产品质量监督检验研究院及院属各中心网站内容刊登审批单')
    }
...
<html>
<head>
    <title>河北省产品质量监督检验研究院及院属各中心网站内容刊登审批单</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
</head>
<body>
<div>
...
<table style="width: 756px;height: 100px">
    <tr>
        <td style="width: 756px;font-size:30px;height:100px" align='center' valign='middle' colspan="8">河北省产品质量监督检验研究院及
        </td>
    </tr>
    <tr>
        <td style="width: 756px;font-size:30px;height:100px" align='center' valign='middle' colspan="8">院属各中心网站内容刊登审批单
        </td>
    </tr>
    <tr>
        <td style="width: 756px;font-size:30px;height:100px" align='center' valign='middle' colspan="4">
        </td>
        <td style="width: 756px;font-size:30px;height:100px" align='center' valign='middle' colspan="4">
...
<table border="1" cellspacing="0" style="width: 794px;height: 1090px">
    <tr style="height: 20px;">
        <td style="width: 100px;text-align: center">申请部门</td>
        ...
        <td style="width: 100px; text-align: center">承办人</td>
        <td style="width: 100px; text-align: center"colspan="2">
            <c:if test="${data.get(0).size()>0 && data.get(0) != null}">
            <c:forEach items="${data.get(0)}" var="da" varStatus="status">
                <c:forEach items="${data.get(0)}" var="da" varStatus="status">
    ...
    <tr style="height: 50px;">
        <td style="width: 100px;text-align: center">刊登内容</td>
    ...
    <tr style="height:50px"aria-rowspan="2">
        <td style="width: 100px;text-align: center">有无附件/照片（如有,请添加附件）</td>
        <td style="width: 620px;text-align: center"colspan="5">
            <c:if test="${data.get(0).size()>0 && data.get(0) != null}">
                <c:forEach items="${data.get(0)}" var="da" varStatus="status">
                    ${da.get("fj")}
    ...
    <tr style="height:50px"aria-rowspan="2">
        <td style="width: 100px;text-align: center">申请部门意见</td>
        <td style="width: 620px;text-align: center"colspan="5">
            <c:if test="${data.get(0).size()>0 && data.get(0) != null}">
    ...
    <tr style="height:50px"aria-rowspan="2">
        <td style="width: 100px;text-align: center">信息数据部意见</td>
        <td style="width: 620px;text-align: center"colspan="5">
            <c:if test="${data.get(0).size()>0 && data.get(0) != null}">
    ...
    <tr style="height:50px"aria-rowspan="2">
        <td style="width: 100px;text-align: center">申请部门主管院长意见</td>
        <td style="width: 620px;text-align: center"colspan="5">
            <c:if test="${data.get(0).size()>0 && data.get(0) != null}">
    ...
    <tr style="height:50px"aria-rowspan="2">
        <td style="width: 100px;text-align: center">审批部门主管院长意见</td>
        <td style="width: 620px;text-align: center"colspan="5">
            <c:if test="${data.get(0).size()>0 && data.get(0) != null}">
