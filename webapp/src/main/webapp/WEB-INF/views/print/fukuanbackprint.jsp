...
<table style="width: 756px;height: 90px;padding-top: 35px">
    <tr>
        <td style="width: 756px;font-size:30px;height:90px" align='center' valign='middle' colspan="4">预付款收回申请单
        </td>
    </tr>
</table>
<table style="width: 756px;height: 20px; overflow-y:scroll">
    <tr>
        ...
        <td style="text-align: left" colspan="2" width="50%">申请时间：${data.get(2).get("year")}年${data.get(3).get("month")}月${data.get(4).get("day")}日</td>
    </tr>
</table>
<table border="1" cellspacing="0" style="width: 756px;height: 450px; overflow-y:scroll">
      <tr>
        <td style="text-align: center" width="20%">金额</td>
        <td style="text-align: center">￥${data.get(5).get("je20051400002")}</td>
        <td width="20%" style="text-align: center">开支内容</td>
        <td style="text-align: center">${data.get(5).get("kznr200514002")}</td>
    </tr>
    <tr>
        <td style="text-align: center" width="20%">金额大写</td>
        <td style="text-align: center" colspan="3">${data.get(10).get("je")}圆整</td>

    </tr>
    <tr>
        <td style="text-align: center" width="20%">部门主任</td>
        <td style="text-align: center" colspan="3">${data.get(6).get("bmzr")}</td>
    </tr>
    <tr>
        <td style="text-align: center" width="20%">财务监督</td>
        <td style="text-align: center" colspan="3">${data.get(7).get("jd")}</td>
    </tr>
    <tr>
        <td style="text-align: center" width="20%">财务复核</td>
        <td style="text-align: center" colspan="3">${data.get(8).get("fh")}</td>
    </tr>
    <tr>
        <td style="text-align: center" width="20%">部门主管院长</td>
        <td style="text-align: center" colspan="3">${data.get(9).get("bmzg")}</td>
    </tr>
</table>
<table style="width: 756px;height: 20px; overflow-y:scroll">
    <tr>
        <td style="text-align: left" width="20%">涂抹及修改无效</td>
    </tr>
</table>
</div>
<!--endprint1-->
