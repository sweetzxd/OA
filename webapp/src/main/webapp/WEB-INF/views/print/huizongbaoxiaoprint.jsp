...
<div id="sealdiv" style="width: 756px;height: 506px;margin: 0 auto;">
    <table style="width: 756px;height: 90px;padding-top: 35px">
        <tr>
            <td style="width: 756px;font-size:30px;height:90px" align='center' valign='middle' colspan="4">经费支出汇总报销单
            </td>
        </tr>
    </table>
    <table style="width: 756px;height: 20px; overflow-y:scroll">
        <tr>
            ...
            <td style="text-align: left" colspan="2" width="50%">申请时间：${data.get(0).get("recordTime")}</td>
        </tr>
    </table>
    <table border="1" cellspacing="0" style="width: 756px;height: 450px; overflow-y:scroll">
        <tr>
            <td style="text-align: center" width="20%">总金额(元)</td>
            <td style="text-align: center">￥${data.get(0).get("je20051500002")}</td>
            <td style="text-align: center" width="20%">支出类型</td>
            <td style="text-align: center">${data.get(0).get("zclx200520001")}</td>

        </tr>
        <tr>
            <td style="text-align: center" width="20%">金额大写</td>
            <td style="text-align: center">${data.get(0).get("jeDX")}</td>
            <td width="20%" style="text-align: center">支出事项</td>
            <td style="text-align: center">${data.get(0).get("zclx200515002")}</td>
        </tr>
        <c:if test="${!empty datamx}">
            <c:forEach items="${datamx}" var="field" varStatus="status">
                <tr>
                    <td style="text-align: center" width="20%">部门</td>
                    <td style="text-align: center">${field.get("bm")}</td>
                    <td width="20%" style="text-align: center">金额(元)</td>
                    <td style="text-align: center">${field.get("je20051900002")}</td>
                </tr>
            </c:forEach>
        </c:if>
        ...
        <tr>
            ...
            <c:if test="${!empty databmbz}">
                <c:forEach items="${databmbz}" var="field" varStatus="status">
                    <div class="msg-box">
                        <label class="title">${field.get("yijian")}</label>
                        <label class="name">${field.get("recordName")}</label>
                        <label class="time">${field.get("recordTime")}</label>
                    </div>
                </c:forEach>
            </c:if>
            </td>
        ...
        <tr>
            ...
            <td style="text-align: center" colspan="3">
                <div class="msg-box">
                    <label class="title">${data.get(1).get("yijian")}</label>
                    <label class="name">${data.get(1).get("recordName")}</label>
                    <label class="time">${data.get(1).get("recordTime")}</label>
                </div>
        ...
        <tr>
            ...
            <td style="text-align: center" colspan="3">
                <div class="msg-box">
                    <label class="title">${data.get(2).get("yijian")}</label>
                    <label class="name">${data.get(2).get("recordName")}</label>
                    <label class="time">${data.get(2).get("recordTime")}</label>
                </div>
        ...
        <tr>
            <td style="text-align: center" width="20%">财务主任</td>
            <td style="text-align: center" colspan="3">
                <div class="msg-box">
                    <label class="title">${data.get(3).get("yijian")}</label>
                    <label class="name">${data.get(3).get("recordName")}</label>
                    <label class="time">${data.get(3).get("recordTime")}</label>
                </div>
        ...
        <tr>
            ...
            <td style="text-align: center" colspan="3">
                <div class="msg-box">
                    <label class="title">${data.get(4).get("yijian")}</label>
                    <label class="name">${data.get(4).get("recordName")}</label>
                    <label class="time">${data.get(4).get("recordTime")}</label>
                </div>
        ...
        <tr>
            ...
            <td style="text-align: center" colspan="3">
                <div class="msg-box">
                    <label class="title">${data.get(5).get("yijian")}</label>
                    <label class="name">${data.get(5).get("recordName")}</label>
                    <label class="time">${data.get(5).get("recordTime")}</label>
                </div>
        ...
        <tr>
            ...
            <td style="text-align: center" colspan="3">
                <div class="msg-box">
                    <label class="title">${data.get(6).get("yijian")}</label>
                    <label class="name">${data.get(6).get("recordName")}</label>
                    <label class="time">${data.get(6).get("recordTime")}</label>
                </div>
    ...
    <table style="width: 756px;height: 20px; overflow-y:scroll">
        <tr>
            ...
            <td style="text-align: right" width="70%">2万元及以上需主管院长和院长签字</td>
        </tr>
    </table>
    <!--endprint1-->
</div>
