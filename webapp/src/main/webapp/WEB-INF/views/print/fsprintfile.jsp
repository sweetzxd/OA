...
<div id="swdiv" style="width: 856px;height: 100%;margin: 0 auto;">
    <!--startprint1-->
    <div style="width: 856px;margin: 0 auto;height: 100%;">
        <table style="width: 856px;height: 10%">
            <tr style="width: 856px;height: 5%;">
                <td style="width: 856px;font-size:30px;height:100px;" align='center' valign='middle' colspan="4">河北省产品质量监督检验研究院收文承办单
                </td>
            </tr>
            <tr style="width: 856px;height: 5%;">
        ...
        <table border="1" cellspacing="0" style="width: 856px;height: 85%; overflow-y:scroll">
            <tr style="height: 5%">
            ...
            <tr style="height: 25%">
                ...
                <td style="width: 656px;text-align: center" colspan="5">
                    <c:forEach items="${data}" var="da" varStatus="status">
                        <c:if test="${fn:contains(da,'yz')}">
                            <div class="msg-box">
                                <label class="title">${da.yz}</label>
