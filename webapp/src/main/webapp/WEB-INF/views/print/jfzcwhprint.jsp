...
<table style="width: 756px;height: 90px;padding-top: 35px">
    <tr>
        <td style="width: 756px;font-size:30px;height:90px" align='center' valign='middle' colspan="4">经费支出维修(护)单
        </td>
    </tr>
</table>
...
<table border="1" cellspacing="0" style="width: 756px;height: 450px; overflow-y:scroll">
    <tr>
        ...
        <td style="text-align: center">￥${data.get(0).get("hjjeX201027002")}</td>
        <td style="text-align: center" width="20%">支出类型</td>
        <td style="text-align: center">${data.get(0).get("zcsxX201027001")}</td>

    </tr>
      <tr>
          <td style="text-align: center" width="20%">金额大写</td>
          <td style="text-align: center">${data.get(0).get("jedxX201027002")}</td>
        <td width="20%" style="text-align: center">支出事项</td>
        <td style="text-align: center">维修(维护)</td>
    </tr>
    <tr>
        <td style="text-align: center" width="20%">维修(护)设备名称</td>
        <td style="text-align: center">${data.get(0).get("wxhsbX20102702")}</td>
        <td style="text-align: center" width="20%">设备编号</td>
        <td style="text-align: center">${data.get(0).get("sbbhX201027002")}</td>
    </tr>
    ...
    <tr>
        ...
        <td style="text-align: center" colspan="3">
            <div class="msg-box">
                <label class="title">${data.get(7).get("yijian")}</label>
                <label class="name">${data.get(7).get("recordName")}</label>
                <label class="time">${data.get(7).get("recordTime")}</label>
            </div>
