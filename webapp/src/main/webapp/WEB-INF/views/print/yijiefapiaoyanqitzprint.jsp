...
<table style="width: 956px;height: 90px;padding-top: 35px">
    <tr>
        <td style="width: 756px;font-size:30px;height:90px" align='center' valign='middle' colspan="4">预借发票延期归还申请单
        </td>
    </tr>
</table>
...
<table border="1" cellspacing="0" style="width: 956px;height: 450px; overflow-y:scroll">
    <tr>
        ...
        <td style="text-align: center">￥${data.get(0).get("jeX20101600001")}</td>
        <td style="text-align: center" width="20%">原借款发票日期</td>
        <td style="text-align: center">${data.get(0).get("yjfprX20101602")}</td>

    </tr>
      <tr>
          <td style="text-align: center" width="20%">金额大写</td>
          <td style="text-align: center">${data.get(0).get("jeDX")}</td>
        <td width="20%" style="text-align: center">申请延期归还日期</td>
        <td style="text-align: center">${data.get(0).get("sqyqgX20101601")}</td>
    </tr>
    <tr>
        <td style="text-align: center" width="20%">发票开具单位</td>
        <td style="text-align: center">${data.get(0).get("fpkjdX20101602")}</td>
        <td style="text-align: center" width="20%">延期还款理由</td>
        <td style="text-align: center">${data.get(0).get("yqghlX20101602")}</td>
    </tr>
    ...
    <tr>
        <td style="text-align: center" width="20%">院长批示</td>
        <td style="text-align: center" colspan="3">${data.get(3).get("recordName")}</td>
...
<table style="width: 956px;height: 20px; overflow-y:scroll">
    <tr>
        ...
        <td style="text-align: right" width="70%">领用发票后，如发生票据丢失、收费不到位等情况，本人承担相应责任</td>
    </tr>
</table>
<!--endprint1-->
</div>
