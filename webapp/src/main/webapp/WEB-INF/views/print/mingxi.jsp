...
<div>
    <label style="text-align: left">${type}明细</label>
    <table border="1px">
        <tr>
            <td>序号</td>
            <td>申请人</td>
        ...
        <c:forEach items="${maps}" var="data" varStatus="status">
            <tr>
                <td>${status.index+1}</td>
                <td>${data.get("sqname")}</td>
                ...
                <td>${data.get("syname")}</td>
                <td>${data.get("bm")}</td>
            </tr>
        </c:forEach>
        <tr><td colspan="15" style="text-align: left"><label style="text-align: left">金额合计: ${hjjine}元</label></td> </tr>
    </table>
</div>
<script>
