...
<table style="width: 756px;height: 90px;padding-top: 35px">
    <tr>
        <td style="width: 756px;font-size:30px;height:90px" align='center' valign='middle' colspan="4">现金借款申请单
        </td>
    </tr>
</table>
<table style="width: 756px;height: 20px; overflow-y:scroll">
    <tr>
        <td style="text-align: left" width="25%">申请人：${data.get(1).get("jkr")}</td>
        <td style="text-align: left" width="25%">部门：${data.get(0).get("bm")}</td>
        <td style="text-align: left" colspan="2" width="50%">申请时间：${data.get(5).get("year")}年${data.get(6).get("month")}月${data.get(7).get("day")}日</td>
    </tr>
</table>
<table border="1" cellspacing="0" style="width: 756px;height: 450px; overflow-y:scroll">
      <tr>
          <td style="text-align: center" width="20%">借款金额</td>
        <td style="text-align: center">￥${data.get(11).get("jkje200514002")}</td>
          <td style="text-align: center" width="20%">预计归还日期</td>
    ...
    <tr>
        ...
        <td style="text-align: center">${data.get(11).get("yt20051400002")}</td>
    ...
    <%--<tr>--%>
        <%--<td style="text-align: center" width="20%">支出意见</td>--%>
