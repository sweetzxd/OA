...
public class WxMessageController {
     ...
     * @description: 聊天信息推送
     */
    @RequestMapping(value = "/chatmessage", method = RequestMethod.GET, produces = "application/json;charset=UTF-8")
    public void setChatMessage(String user) {
        String name = ToNameUtil.getName("user", user);
        JPushAllService.jpush(user, "您有一条[" + name + "]发送的未读消息", null);
    }
